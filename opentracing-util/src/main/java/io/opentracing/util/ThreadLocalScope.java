...
public class ThreadLocalScope implements Scope {
    ...
    ThreadLocalScope(ThreadLocalScopeManager scopeManager, Span wrapped, Scope.Observer scopeObserver) {
