...
public class ThreadLocalActiveSpan implements ActiveSpan {
    ...
    ThreadLocalActiveSpan(Source source, Span wrapped, AtomicInteger refCount) {
        this.source = source;
    ...
    static class Continuation implements ActiveSpan.Continuation {
        ...
        Continuation(Source source, Span span, AtomicInteger refCount) {
            this.source = source;
            this.refCount = refCount;
            this.span = span;
        }
    ...
    public static class Source implements ActiveSpan.Source {
        private final ThreadLocal<ThreadLocalActiveSpan> tlsSnapshot = new ThreadLocal<ThreadLocalActiveSpan>();

        Continuation makeContinuation(Span span, AtomicInteger refCount) {
            return new Continuation(this, span, refCount);
        }
